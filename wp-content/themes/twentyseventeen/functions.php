...
/*function wds_cpt_search( $query ) {
    ...
    if ( is_search() && $query->is_main_query() && $query->get( 's' ) ){
		...
		$query->set('post_type', array('taxon'));
		//$query->set('meta_key', 'espece_type');
...
//wp_localize_script( 'taxonsInfos', get_template_directory_uri().'taxonInfos.js', array('jquery') );
//wp_localize_script( 'taxonsInfos', 'adminAjax', admin_url( 'admin-ajax.php' ) );
add_action( 'wp_ajax_nopriv_taxons_search', 'taxons_search' );
add_action( 'wp_ajax_taxons_search', 'taxons_search' );

function add_js_scripts() {
	wp_enqueue_script( 'taxonsSearch', get_template_directory_uri().'/js/script.js', array('jquery'), '1.0', true );
